...
# ファイル名: tad_dynamic_boundary_specificity_test_v6.py
# 処理内容:
...
#   python tad_dynamic_boundary_specificity_test_v6.py
#
# 実行例（Level 3, 10000 resamples）:
#   MATCH_LEVEL=3 N_RESAMPLES=10000 python tad_dynamic_boundary_specificity_test_v6.py
#
# 実行例（Level 1, 探索）:
#   MATCH_LEVEL=1 N_RESAMPLES=1000 python tad_dynamic_boundary_specificity_test_v6.py
#
# 環境変数:
...
# #SBATCH --output=specificity_test_v6_L%e_%j.log
...
_OVERLAP_TABLE = str(F_04_EVENT_OVERLAP)
_BURDEN_TABLE = str(F_05_SAMPLE_BURDEN_L2)
...
_OUTDIR = os.environ.get(
    "OUTDIR",
    str(OUT_07_MATCHED_STATIC / f"output_tad_dynamic_boundary_specificity_v6_L{MATCH_LEVEL}")
)
...
_MAIN_TSV = f"specificity_test_results_main_v6_L{MATCH_LEVEL}{_CLASS_SUFFIX}.tsv"
_PER_SAMPLE_TSV = f"specificity_test_per_sample_v6_L{MATCH_LEVEL}{_CLASS_SUFFIX}.tsv"
_FIGURE_SUMMARY_TSV = f"specificity_test_figure_summary_v6_L{MATCH_LEVEL}{_CLASS_SUFFIX}.tsv"
_QC_JSON = f"specificity_test_qc_v6_L{MATCH_LEVEL}{_CLASS_SUFFIX}.json"
_EVENT_TSV = f"specificity_test_event_level_v6_L{MATCH_LEVEL}{_CLASS_SUFFIX}.tsv"
...
def main() -> None:
    ...
    qc = {
        "script": "tad_dynamic_boundary_specificity_test_v6.py",
        "version": "v6",
    ...
    log("=" * 80)
    log("tad_dynamic_boundary_specificity_test_v6.py")
