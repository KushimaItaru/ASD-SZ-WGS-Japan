...
#          (v10: sample-level top-1% QC 適用済み)
#      05_wgs_sample_burden/output_v3/sample_burden_L2_and_specificity_v3.tsv
#          (v3: 04_v10 由来の共変量 + サンプル単位 burden)
...
#      2. bin_l2_annotation の 25-kb bin 座標と exon を交差
...
#      7. 出力:
#           wgs_exon_exclusion_v3.tsv
#           wgs_exon_exclusion_summary_v3.tsv
#  - 出力先: /lustre12/home/kushima-pg/tad04212026/12_exon_exclusion_wgs/output_v3/
#  - 処理時間を先頭と末尾で記録
...
#SBATCH --output=42_compute_wgs_exon_exclusion_v3_%j.out
#SBATCH --error=42_compute_wgs_exon_exclusion_v3_%j.err
...
# =========================================================
# PATHS (tad04212026 パイプライン、v3: 04_v10 + 05_v3 入力)
# =========================================================
...
# v3: 04_v10 の event overlap を参照
EVENT_OVERLAP = (
    BASE_TAD / "04_wgs_sv_boundary_overlap" / "output_v10"
    / "sample_boundary_event_overlap_v10.tsv.gz"
)
# v3: 05_v3 の burden を参照
BURDEN_TABLE = (
    BASE_TAD / "05_wgs_sample_burden" / "output_v3"
    / "sample_burden_L2_and_specificity_v3.tsv"
)

OUT_DIR = BASE_TAD / "12_exon_exclusion_wgs" / "output_v3"
OUT_TSV = OUT_DIR / "wgs_exon_exclusion_v3.tsv"
OUT_SUMMARY = OUT_DIR / "wgs_exon_exclusion_summary_v3.tsv"
...
def main() -> None:
    log("=" * 72)
    log("Script 12 v3 START: WGS exon-exclusion sensitivity (tad04212026)")
    log("  42_compute_wgs_exon_exclusion_v3.py")
    log("  Input: 04_v10 event overlap + 05_v3 burden (sample-level top-1% QC applied)")
    log("=" * 72)
    ...
    log("\n" + "=" * 72)
    log(
        f"Script 12 v3 DONE: 42_compute_wgs_exon_exclusion_v3.py  "
