#!/usr/bin/env python3
"""
14_annotate_genes_per_domain_v4.py

v3 → v4 変更点 (v7 round の Diff_any-bounded domain と整合):
- DOM_BED input path を tad_domains_v4.bed → diffany_bounded_domains_v7.bed に変更
- output ファイル名 suffix を _v3 → _v4 に変更
- LOEUF unknown 分離・gene-domain midpoint assignment 等の logic は v2/v3 から不変
...
- output_v1/diffany_bounded_domains_v7.bed (v7: Diff_any-bounded TAD-scale)

出力:
- output_v1/genes_per_domain_v4.tsv.gz
- output_v1/domain_constraint_summary_v4.tsv
...
DOM_BED = BASE_DIR / '14_constraint_enrichment_v1/output_v1/diffany_bounded_domains_v7.bed'
...
out_genes = OUT_DIR / 'genes_per_domain_v4.tsv.gz'
...
out_summary = OUT_DIR / 'domain_constraint_summary_v4.tsv'
