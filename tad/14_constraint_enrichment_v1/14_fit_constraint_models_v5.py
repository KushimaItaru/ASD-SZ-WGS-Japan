#!/usr/bin/env python3
"""
14_fit_constraint_models_v5.py
...
入力:
- output_v1/sample_constrained_burden_discovery_v5.tsv (covariate joined)
- output_v1/sample_constrained_burden_arraycgh_v5.tsv (covariate joined)
- output_v1/sample_constrained_burden_mssng_v5.tsv  (covariate joined, sanitized dummies)

出力:
- output_v1/constraint_enrichment_results_v5.tsv
...
EXPOSURE_DISC = OUT_DIR / 'sample_constrained_burden_discovery_v5.tsv'
EXPOSURE_ACGH = OUT_DIR / 'sample_constrained_burden_arraycgh_v5.tsv'
EXPOSURE_MSSNG = OUT_DIR / 'sample_constrained_burden_mssng_v5.tsv'
...
# Save results
# ============================================================
out_results = OUT_DIR / 'constraint_enrichment_results_v5.tsv'
