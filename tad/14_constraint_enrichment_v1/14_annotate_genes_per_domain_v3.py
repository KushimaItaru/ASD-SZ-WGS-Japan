#!/usr/bin/env python3
"""
14_annotate_genes_per_domain_v3.py

v2 → v3 変更点 (v6 round の TAD anchor schema fix と整合させるため):
- DOM_BED input path を tad_domains_v3.bed → tad_domains_v4.bed に変更
- output ファイル名 suffix を _v2 → _v3 に変更
- LOEUF unknown 分離・gene-domain midpoint assignment 等の logic は v2 から不変
...
- output_v1/tad_domains_v4.bed (v4: anchor schema fix)

出力:
- output_v1/genes_per_domain_v3.tsv.gz
- output_v1/domain_constraint_summary_v3.tsv
...
DOM_BED = BASE_DIR / '14_constraint_enrichment_v1/output_v1/tad_domains_v4.bed'
...
out_genes = OUT_DIR / 'genes_per_domain_v3.tsv.gz'
...
out_summary = OUT_DIR / 'domain_constraint_summary_v3.tsv'
