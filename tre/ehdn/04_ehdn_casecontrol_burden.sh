...
JOB1=$(sbatch --parsable \
    ...
    --wrap="bash -lc 'source ~/.bashrc && conda activate ${CONDA_ENV_NAME} && python3 ${HELPER_DIR}/14_outlier_burden_rare_casecontrol_crossfit_v19.py'")
...
JOB2=$(sbatch --parsable --dependency=afterok:${JOB1} \
    ...
    --wrap="bash -lc 'source ~/.bashrc && conda activate ${CONDA_ENV_NAME} && python3 ${HELPER_DIR}/17_burden_statistical_test_v20.py'")
